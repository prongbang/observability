...
type CoinClient interface {
	GetCoin(ctx context.Context, in *CoinRequest, opts ...grpc.CallOption) (*CoinResponse, error)
}
...
func (c *coinClient) GetCoin(ctx context.Context, in *CoinRequest, opts ...grpc.CallOption) (*CoinResponse, error) {
	out := new(CoinResponse)
	err := c.cc.Invoke(ctx, "/coin.Coin/GetCoin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoinServer interface {
	GetCoin(context.Context, *CoinRequest) (*CoinResponse, error)
...
func (UnimplementedCoinServer) GetCoin(context.Context, *CoinRequest) (*CoinResponse, error) {
...
func _Coin_GetCoin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/coin.Coin/GetCoin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoinServer).GetCoin(ctx, req.(*CoinRequest))
	}
